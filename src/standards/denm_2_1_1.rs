...
pub mod d_e_n_m__p_d_u__description {
    ...
    #[doc = "* "]
    #[doc = " * This type represents the À La Carte Container."]
    #[doc = " *"]
    ...
    #[doc = "* "]
    #[doc = " * This type contains detailed information about the vehicle in which the originating ITS-S is mounted, for mitigating the consequences of a collision."]
    #[doc = " *"]
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    ...
    #[doc = " *"]
    #[doc = " * @field positionOfPillars: information about the vertical support of the vehicle in which the originating ITS-S is mounted. It shall be included for passenger vehicles only."]
    #[doc = " *"]
    ...
    #[doc = " *"]
    #[doc = " * @field detectionZonesToEventPosition: the detection zone information approaching the event position."]
    #[doc = " *"]
    #[doc = " * @field roadType: the optional road type information at the event position. "]
    #[doc = " *"]
    #[doc = " * @field lanePositions: the optional lane(s) where the event is located, at the position indicated by the component eventPosition of the Management container."]
    #[doc = " *"]
    #[doc = " * @field occupiedLanes: the optional lane(s) that are fully or partially occupied by the event, at the position indicated by the component eventPosition of the Management container."]
    #[doc = " *"]
    ...
    #[doc = " * applying to the road segment(s) covered by the components detectionZonesToEventPosition, detectionZonesToSpecifiedEventPoint and the SituationContainer component eventZone."]
    #[doc = " *"]
    ...
    #[doc = " * applying to the road segment(s) covered by the component detectionZonesToEventPosition, detectionZonesToSpecifiedEventPoint and the SituationContainer component eventZone."]
    #[doc = " *"]
    #[doc = " * @field detectionZonesToSpecifiedEventPoint: the optional detection zone information approaching towards a specified event point. "]
    #[doc = " *"]
    ...
    #[doc = " *"]
    #[doc = " * @field awarenessDistance: the optional radius of the circular awareness area, with centre at the event position or at any of the event history points as defined in clause 6.1.3.1."]
    #[doc = " *"]
    #[doc = " * @field awarenessTrafficDirection: the optional traffic direction along which the receiving ITS-S may encounter the event, as defined in clause 6.1.3.1."]
    #[doc = " *"]
    ...
    #[doc = " *"]
    #[doc = " * @field transmissionInterval: the optional time interval for DENM transmission as defined by the originating ITS-S. If the component is not present in DENM, a default value defaultValidity is assumed."]
    #[doc = " *"]
    ...
    pub struct ManagementContainer {
        ...
        #[rasn(identifier = "awarenessTrafficDirection")]
    ...
    #[doc = " *"]
    #[doc = " * @field impactSection: indication of the object\u{92}s section where the impact will most likely occur. "]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field lightBarSirenInUse: optionally indicates whether a roadwork vehicle has switched on the light bar or siren. It is used when the roadwork involves a specific roadwork vehicle"]
    #[doc = " *"]
    ...
    #[doc = " *"]
    #[doc = " * @field restriction: the optional type(s) of vehicles that are restricted to access the road work zone. More than one vehicle types may be provided by this component if the restriction apply to multiple vehicle types. "]
    #[doc = " *"]
    ...
    #[doc = " *"]
    #[doc = " * @field recommendedPath: the optional recommended itinerary in order to contour the roadworks zone."]
    #[doc = " * If present, a recommended path shall be a list of path points in the order from the starting point closest to the roadworks zone to the end point of the recommended path. "]
    #[doc = " *"]
    #[doc = " * @field startingPointSpeedLimit: the optional effective starting position of a speed limit being applied to the roadwork zone, w.r.t. the component eventPosition on the Management Container."]
    ...
    #[doc = " *"]
    #[doc = " * @field linkedCause: the optional type of a linked event co-existing at the same time and the same place (same event zone), including direct cause and sub cause of the linked event, "]
    #[doc = " * for which no other DENM is sent out."]
    #[doc = " *"]
    #[doc = " * @field eventZone: an optional list of EventPoint, using the position indicated in the component eventPosition of the Management container as the reference position for the first EventPoint."]
    #[doc = " *"]
    #[doc = " * @field linkedDenms: the optional list of DF ActionId, pointing to DENMs that are semantically connected because applying to consecutive event zones at the same time."]
    #[doc = " *"]
    #[doc = " * @field eventEnd: the end position of the event along the road that is affected by the event w.r.t. the component eventPosition of the Management container. "]
...
pub mod e_t_s_i__i_t_s__c_d_d {
    ...
    #[doc = "*"]
    #[doc = " * This DF represents transversal position information w.r.t the road, at an externally defined reference position. It shall contain a set of up to `4` @ref GeneralizedLanePosition."]
    ...
    #[doc = " * "]
    #[doc = " * @field pathDeltaTime: the optional travel time separated from the waypoint to the predefined reference position."]
    #[doc = ""]
    #[doc = " * @field symmetricAreaOffset: the optional symmetric offset applied to the position in order to generate a shape."]
    #[doc = " * if the component asymmetricAreaOffset is absent, the symmetricAreaOffset is applied to both sides of the position (left and right)"]
    #[doc = " * If the component asymmetricAreaOffset is present, the symmetricAreaOffset is applied to the enclosed side of a curve. "]
    #[doc = " * If the curvature of the path is 0 the offset is applied to the left handside of the path. "]
    #[doc = " * To determine how the lateral offset is to be applied to the path, the following steps are executed: "]
    #[doc = " * - For each nth pathPointPredicted (ppp_n), vectors v_(n-) and v_(n+) from ppp_n to ppp_(n-1) and from ppp_n to ppp_(n+1) are created. "]
    #[doc = " * - v^_(n-) and v^_(n+), the normalized vectors of vectors v_(n-) and v_(n+) are created.  "]
    #[doc = " * - v^_o the normalized sum of the vectors v^_(n-) and v^_(n+) is calculated. "]
    #[doc = " * The symmetrical border offset spans a vector in the direction of both v^_o and -v^_o, if the asymmetrical border offset is ABSENT."]
    #[doc = " * The symmetrical border offset spans a vector in the direction of v^_o if the asymmetrical border offset is PRESENT."]
    #[doc = " * The ends of the border offsets vectors of ppp_n for each side are connected to the border offsets vectors of the endings of ppp_(n-1) and ppp_(n+1) to create the indicated zone. "]
    #[doc = " * If @ref PathPredicted has only one element, the encoded area represents a circle with the asymmetricAreaOffset as the defining radius."]
    #[doc = " *  "]
    #[doc = " * @field asymmetricAreaOffset: the optional asymmetric offset applied to the outer curve of the path in order to generate a shape. "]
    #[doc = " * The asymmetrical border offset spans a vector in the direction of -v^_o"]
    #[doc = " *"]
    #[doc = " * @category GeoReference information"]
    ...
    #[doc = " * It shall contain up to `16` @ref PathPoint. "]
    #[doc = " * "]
    #[doc = " * The first PathPoint presents an offset delta position with regards to an external reference position."]
    #[doc = " * Each other PathPoint presents an offset delta position and optionally an offset travel time with regards to the previous PathPoint. "]
    #[doc = " *"]
    ...
    #[doc = "*"]
    #[doc = " * This DF describes a radial shape. The circular sector or cone is constructed by sweeping      "]
    ...
    #[doc = " * "]
    #[doc = " * @field includedPaths: the identifier(s) of the trace(s) that covers (either with all its length or with a part of it) a RoadConfigurationSection. "]
    #[doc = " *"]
    ...
    #[doc = " * - 9 to 15                   - are reserved for future usage. "]
    #[doc = " *"]
    #[doc = " * @category: VRU information"]
    #[doc = " * @revision: Created in V2.1.1"]
    #[doc = " "]
