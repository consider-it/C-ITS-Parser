...
impl ExtendedChannelInfo {
    pub fn decode_value<D: Decoder>(&self, decoder: &mut D) -> Result<ChInfoTypes_Type, D::Error> {
...
impl RoutAdvertExtTypes_ExtValue {
    ...
    pub fn encode<E: Encoder>(&self, encoder: &mut E, identifier: &RefExt) -> Result<(), E::Error> {
        match (self, identifier) {
            (Self::CSecondaryDNS(inner), i) if i == &C__SECONDARY_D_N_S => inner.encode(encoder),
...
impl ServiceInfoExtTypes_ExtValue {
    ...
    pub fn encode<E: Encoder>(&self, encoder: &mut E, identifier: &RefExt) -> Result<(), E::Error> {
        match (self, identifier) {
            ...
            (Self::CRCPIthreshold(inner), i) if i == &C__R_C_P_ITHRESHOLD => inner.encode(encoder),
