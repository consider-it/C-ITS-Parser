...
macro_rules! btp {
    ($btp_ty:ty, $input:ident) => {
        <$btp_ty>::decode($input)
            ...
            .map_err(map_err_to_string)
            .and_then(|json| {
                Uint8Array::try_from(json.as_bytes())
                    .map(|buf| (4, Some(buf)))
                    .map_err(map_err_to_string)
            })
    };
...
pub struct EtsiJson {
    pub geonetworking: Option<Uint8Array>,
    pub transport: Option<Uint8Array>,
    pub its: Option<Uint8Array>,
}
...
pub fn decodeDenmToJson(
    ...
    etsi_json.its = match version {
        131 => Some(transcode_uper_to_jer_bytes::<standards::denm_1_3_1::DENM>(
            &denm[bytes_read..],
        ))
        .transpose(),
        211 => Some(transcode_uper_to_jer_bytes::<standards::denm_2_1_1::DENM>(
            &denm[bytes_read..],
        ))
        .transpose(),
        _ => {
...
pub fn decodeCamToJson(
    ...
    etsi_json.its = match version {
        141 => Some(transcode_uper_to_jer_bytes::<standards::cam_1_4_1::CAM>(
            &cam[bytes_read..],
        ))
        .transpose(),
        _ => {
...
pub fn decodeMapemToJson(
    ...
    etsi_json.its = match version {
        131 => Some(transcode_uper_to_jer_bytes::<standards::is_1_3_1::MAPEM>(
            &mapem[bytes_read..],
        ))
        .transpose(),
        _ => {
...
pub fn decodeSpatemToJson(
    ...
    etsi_json.its = match version {
        131 => Some(transcode_uper_to_jer_bytes::<standards::is_1_3_1::SPATEM>(
            &spatem[bytes_read..],
        ))
        .transpose(),
        _ => {
...
pub fn decodeIvimToJson(
    ...
    etsi_json.its = match version {
        131 => Some(transcode_uper_to_jer_bytes::<standards::is_1_3_1::IVIM>(
            &ivim[bytes_read..],
        ))
        .transpose(),
        _ => {
...
pub fn decodeSremToJson(
    ...
    etsi_json.its = match version {
        131 => Some(transcode_uper_to_jer_bytes::<standards::is_1_3_1::SREM>(
            &srem[bytes_read..],
        ))
        .transpose(),
        _ => {
...
pub fn decodeSsemToJson(
    ...
    etsi_json.its = match version {
        131 => Some(transcode_uper_to_jer_bytes::<standards::is_1_3_1::SSEM>(
            &ssem[bytes_read..],
        ))
        .transpose(),
        _ => {
...
fn decode_geonetworking_header(
    input: &[u8],
) -> Result<(usize, Option<Uint8Array>, Option<NextAfterCommon>), String> {
            ...
            (
                ...
                Some(
                    gn.encode_to_json()
                        .map_err(map_err_to_string)
                        .and_then(|json| {
                            Uint8Array::try_from(json.as_bytes()).map_err(map_err_to_string)
                        }),
                ),
            )
        })
...
) -> Result<(usize, Option<Uint8Array>), String> {
    match header_type {
...
fn transcode_uper_to_jer_bytes<T: rasn::Decode + rasn::Encode>(
    ...
    rasn::jer::encode(&rasn::uper::decode::<T>(input).map_err(map_err_to_string)?)
        .map_err(map_err_to_string)
        .and_then(|json| Uint8Array::try_from(json.as_bytes()).map_err(map_err_to_string))
}
